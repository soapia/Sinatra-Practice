#Option 1: Write your own method to make your own web application!


#Option 2: basic calculator
def add(number1, number2)
  number1+number2
end


#Option 3: to_pig_latin
...
#Option 4: modify the following method so it calculates hours alive (right now it calculates days alive). Then make an hours alive calculator app. 
